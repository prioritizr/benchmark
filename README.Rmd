...
* _packrat_
    + [_R_ package management](https://rstudio.github.io/packrat/).

The files in the _results_ directory are created after completing benchmark analysis. If you wish to access the results completed on our systems, please see files attached the [Results storage release](https://github.com/prioritizr/benchmark/releases/tag/v0.0.2).
