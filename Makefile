...
data/intermediate/02-*.rda: data/intermediate/01-*.rda code/R/analysis/02-*.R code/parameters/land.toml code/parameters/land-cover.toml
...
raw_data: data/raw/species/nplcc_cost_occupancy.zip

data/raw/species/nplcc_cost_occupancy.zip:
	$(R) -e "piggyback::pb_download('nplcc_cost_occupancy.zip',repo='prioritizr/benchmark',dest='data/raw/wdpa',tag='v0.0.1')"
